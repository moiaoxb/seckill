package com.bmw.seckill.common.util;
...
public class EntityUtil {
    ...
    private final String moduleName = "case"; // 数据库名称

    private final String bean_path = "C:\\develop\\bmwSpace2\\seckill-parent\\seckill-service\\src\\main\\java";

    private final String mapper_path = "C:\\develop\\bmwSpace2\\seckill-parent\\seckill-service\\src\\main\\java\\com\\bmw\\seckill\\dao";

    private final String xml_path = "C:\\develop\\bmwSpace2\\seckill-parent\\seckill-service\\src\\main\\resources\\mapping";// xml路径

    private final String model_package = "com.bmw.seckill.model";// model的包所在

    private final String dao_package = "com.bmw.seckill.dao";// dao的包所在

    private final String driverName = "com.mysql.jdbc.Driver";

    private final String user = "deploy";// 数据库用户

    private final String password = "d123456";// "root";//数据库密码

    private final String url = "jdbc:mysql://39.98.55.177:3306/" + moduleName + "?characterEncoding=utf8";
    ...
    public static void main(String[] args) {
        try {
            ...
            // 自动打开生成文件的目录
            // Runtime.getRuntime().exec("cmd /c start explorer G:\\mybatiestest\\");
    ...
    private void buildMapper(List<String> columns, List<String> types) throws IOException {
        ...
        bw.newLine();
        bw.write("import com.bmw.seckill.common.util.bean.CommonQueryBean;");
        bw.newLine();
        bw.newLine();
        ...
        bw.newLine();
        bw.write("\t" + "int count ( " + beanName + " record);");
        bw.newLine();
...
//		List<String> tables = getTables();
        ...
        tables.add("seckill_products");
        tables.add("seckill_user");
        tables.add("seckill_admin");
